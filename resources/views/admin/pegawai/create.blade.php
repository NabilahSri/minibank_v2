...
@section('content')
    <div class="space-y-5 sm:space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div class="min-w-0">
                ...
                <p class="text-xs sm:text-sm text-slate-500 mt-1">
                    Lengkapi data di bawah ini untuk mendaftarkan pegawai beserta akun login
                </p>
            </div>
            <div
                class="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-purple-50 text-purple-600 flex items-center justify-center shrink-0 border border-purple-100">
        ...
        <form id="formCreatePegawai" action="{{ route('pegawai.store') }}" method="POST" novalidate>
            @csrf
                ...
                <div class="lg:col-span-2 space-y-5">
                    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-visible">
                        ...
                        <div class="p-4 sm:p-5 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="nip" name="nip" value="{{ old('nip') }}"
                                        ...
                                        class="w-full pl-9 pr-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition font-mono placeholder:text-slate-400 @error('nip') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror"
                            ...
                            <div class="sm:col-span-1">
                                <label for="lokasi_id"
                                    class="block text-[11px] sm:text-xs font-bold text-slate-700 mb-1.5 flex items-center justify-between gap-2">
                                    <span>Lokasi Kerja <span class="text-rose-500">*</span></span>
                                    <button type="button" id="btnQuickAddLokasiCreate"
                                ...
                                <select id="lokasi_id" name="lokasi_id" required data-searchable="true"
                                    ...
                                    class="w-full px-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition cursor-pointer @error('lokasi_id') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" id="nama" name="nama" value="{{ old('nama') }}"
                                    ...
                                    class="w-full px-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition placeholder:text-slate-400 @error('nama') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror"
                                ...
                                <div class="grid grid-cols-2 gap-2 sm:gap-3">
                                    <label class="relative cursor-pointer">
                                        <input type="radio" name="jk" value="L"
                                            {{ old('jk') === 'L' ? 'checked' : '' }} required class="peer sr-only">
                                        <div
                                    ...
                                    <label class="relative cursor-pointer">
                                        <input type="radio" name="jk" value="P"
                                            {{ old('jk') === 'P' ? 'checked' : '' }} class="peer sr-only">
                                        <div
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <select id="role" name="role" required data-searchable="true"
                                    ...
                                    class="w-full px-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition cursor-pointer @error('role') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror">
                                    <option value="">-- Pilih Role --</option>
                                    <option value="opr" {{ old('role') === 'opr' ? 'selected' : '' }}>Operator
                                        (Petugas Layanan)</option>
                                    <option value="adm" {{ old('role') === 'adm' ? 'selected' : '' }}>Administrator
                                        (Full Akses)</option>
                                </select>
                                @error('role')
                                    <p class="text-[10px] sm:text-xs text-rose-600 mt-1 flex items-center gap-1">
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="tel" id="no_hp" name="no_hp" value="{{ old('no_hp') }}"
                                        maxlength="20"
                                        class="w-full pl-9 pr-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition placeholder:text-slate-400 @error('no_hp') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror"
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" id="email" name="email" value="{{ old('email') }}"
                                        maxlength="100"
                                        class="w-full pl-9 pr-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition placeholder:text-slate-400 @error('email') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror"
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea id="alamat" name="alamat" rows="2" maxlength="255"
                                    class="w-full px-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition placeholder:text-slate-400 resize-none @error('alamat') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror"
                                    placeholder="cth: Jl. Pendidikan No. 123, Surabaya">{{ old('alamat') }}</textarea>
                                @error('alamat')
                                    <p class="text-[10px] sm:text-xs text-rose-600 mt-1 flex items-center gap-1">
                                        <svg class="w-3 h-3 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                        ...
                        <div class="p-4 sm:p-5 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                            <div class="sm:col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="username" name="username" value="{{ old('username') }}"
                                        ...
                                        class="w-full pl-9 pr-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition placeholder:text-slate-400 @error('username') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror"
                            ...
                            <div class="sm:col-span-1">
                                <label for="password"
                                    ...
                                    <span class="font-normal text-slate-400">(min. 6 karakter)</span>
                                </label>
                                <div class="relative">
                                    <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-400 pointer-events-none shrink-0"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <input type="password" id="password" name="password" maxlength="100" required
                                        class="w-full pl-9 pr-10 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition placeholder:text-slate-400 @error('password') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror"
                ...
                <div class="lg:col-span-1 space-y-5">
                        ...
                        <div class="p-4 sm:p-5 space-y-4">
                            <div class="space-y-2.5">
                                <div class="flex items-center justify-between text-[11px] sm:text-xs">
                                    <span class="text-slate-500 font-medium">Total Field Wajib</span>
                                    <span class="font-bold text-slate-800">8 data inti</span>
                                </div>
                    ...
                    <div
                        ...
                        <ul class="space-y-1 list-disc list-inside text-amber-700/90">
                            <li>NIP & Username harus unik antar pegawai</li>
                            <li>Username & password ini dipakai pegawai untuk login</li>
                            <li>Disarankan menginformasikan password awal agar segera diganti</li>
                            <li>Role Admin memiliki akses penuh & bisa kelola pegawai lain</li>
                        </ul>
                    </div>
                </div>
    ...
    <div id="modalQuickAddLokasiCreate"
        ...
        <div
            ...
            <div
                ...
                <button type="button" id="btnCloseModalLokasiCreate"
            ...
            <form id="formQuickAddLokasiCreate" action="{{ route('lokasi.store') }}" method="POST" novalidate>
                @csrf
                <input type="hidden" name="ajax" value="1">
                <div class="p-4 sm:p-5 space-y-4">
                    <div>
                        <label for="quick_nama_lokasi_create"
                            class="block text-[11px] sm:text-xs font-bold text-slate-700 mb-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="quick_nama_lokasi_create" name="nama_lokasi" maxlength="100"
                                required autofocus
                        ...
                        <p id="quick_lokasi_error_create"
                ...
                <div
                    ...
                    <button type="button" id="btnBatalLokasiCreate"
                    ...
                    <button type="submit" id="btnSubmitLokasiCreate"
                        ...
                        <svg id="iconLoadingLokasiCreate" class="w-4 h-4 shrink-0 animate-spin hidden"
                        ...
                        <svg id="iconCheckLokasiCreate" class="w-4 h-4 shrink-0" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <span id="txtBtnLokasiCreate">Simpan Lokasi</span>
                    </button>
                </div>
            </form>
        </div>
        ...
        (function() {
            ...
            function updateProgress() {
                ...
                const fields = document.querySelectorAll(
                    '#formCreatePegawai input[required], #formCreatePegawai select[required], #formCreatePegawai textarea[required]'
                );
            ...
            function initQuickAddLokasi() {
                const modal = document.getElementById('modalQuickAddLokasiCreate');
                const btnOpen = document.getElementById('btnQuickAddLokasiCreate');
                const btnClose = document.getElementById('btnCloseModalLokasiCreate');
                const btnBatal = document.getElementById('btnBatalLokasiCreate');
                const form = document.getElementById('formQuickAddLokasiCreate');
                const input = document.getElementById('quick_nama_lokasi_create');
                const errWrap = document.getElementById('quick_lokasi_error_create');
                const errMsg = errWrap ? errWrap.querySelector('span') : null;
                const btnSubmit = document.getElementById('btnSubmitLokasiCreate');
                const iconLoading = document.getElementById('iconLoadingLokasiCreate');
                const iconCheck = document.getElementById('iconCheckLokasiCreate');
                const txtBtn = document.getElementById('txtBtnLokasiCreate');
            ...
            function initAll() {
                ...
                const all = document.querySelectorAll(
                    '#formCreatePegawai input, #formCreatePegawai select, #formCreatePegawai textarea'
                );
                ...
                const form = document.getElementById('formCreatePegawai');
                if (form) {
                    form.addEventListener('submit', function(e) {
                        ...
                        function doConfirm() {
                            ...
                            window.Swal.fire({
                                ...
                                html: '<p class="text-sm text-slate-600">Pastikan data di bawah sudah benar sebelum disimpan:</p>' +
                                    '<div class="mt-3 text-left text-xs space-y-1 bg-slate-50 p-3 rounded-xl border border-slate-200">' +
