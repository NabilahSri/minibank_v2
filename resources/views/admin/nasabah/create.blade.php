...
@section('page_title', 'Tambah Nasabah Baru')
...
@section('content')
    <div class="space-y-5 sm:space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div class="min-w-0">
                ...
                <p class="text-xs sm:text-sm text-slate-500 mt-1">
                    Lengkapi data di bawah ini untuk mendaftarkan nasabah baru di sistem
                </p>
            </div>
            <div
        ...
        <form id="formCreateNasabah" action="{{ route('nasabah.store') }}" method="POST" novalidate>
            @csrf
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div class="lg:col-span-2 space-y-5">
                        ...
                        <div class="p-4 sm:p-5 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <input type="text" id="nin" name="nin" value="{{ old('nin') }}"
                                    ...
                                    class="w-full px-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition font-mono placeholder:text-slate-400 @error('nin') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror"
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <select id="kategori" name="kategori" required data-searchable="true"
                                    ...
                                    class="w-full px-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition cursor-pointer @error('kategori') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror">
                                    <option value="">-- Pilih Kategori --</option>
                                    <option value="siswa" {{ old('kategori') === 'siswa' ? 'selected' : '' }}>Siswa
                                    </option>
                                    <option value="umum" {{ old('kategori') === 'umum' ? 'selected' : '' }}>Umum (Guru /
                                        Staf / Warga)</option>
                                </select>
                                @error('kategori')
                                    <p class="text-[10px] sm:text-xs text-rose-600 mt-1 flex items-center gap-1">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" id="nama_ortu" name="nama_ortu" value="{{ old('nama_ortu') }}"
                                    maxlength="100"
                                    class="w-full px-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition placeholder:text-slate-400 @error('nama_ortu') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror"
                    ...
                    <div id="boxDataSiswa"
                        class="bg-white rounded-2xl border border-blue-200/60 shadow-sm overflow-hidden transition-all duration-300 {{ old('kategori') === 'siswa' ? '' : 'hidden' }}">
                        ...
                        <div class="p-4 sm:p-5 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                            <div class="sm:col-span-1">
                                ...
                                <input type="text" id="nisn" name="nisn" value="{{ old('nisn') }}"
                                    maxlength="50"
                                    class="nisn-input w-full px-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition font-mono placeholder:text-slate-400 @error('nisn') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror"
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <input type="number" id="tahun_masuk" name="tahun_masuk"
                                    value="{{ old('tahun_masuk') }}" min="2000" max="{{ date('Y') + 1 }}"
                                    step="1"
                                    class="tahun-masuk-input w-full px-3 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 bg-slate-50/50 focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition font-mono placeholder:text-slate-400 @error('tahun_masuk') border-rose-400 focus:border-rose-500 focus:ring-rose-100 bg-rose-50/50 @enderror"
                ...
                <div class="lg:col-span-1 space-y-5">
                        ...
                        <div class="p-4 sm:p-5 space-y-4">
                            <div class="space-y-2.5">
                                <div class="flex items-center justify-between text-[11px] sm:text-xs">
                                    ...
                                    <span class="font-bold text-slate-800">5 data inti + 2 siswa</span>
                                </div>
                    ...
                    <div
                        ...
                        <ul class="space-y-1 list-disc list-inside text-amber-700/90">
                            <li>NIN harus unik, tidak boleh sama antar nasabah</li>
                            <li>Jika nasabah siswa pindah kategori, data siswa akan terhapus otomatis</li>
                            <li>Nomor HP dan email opsional, tapi direkomendasikan diisi</li>
                        </ul>
                    </div>
                </div>
            ...
            function initAll() {
                ...
                function countRequiredFields() {
                    return document.querySelectorAll(
                        '#formCreateNasabah input[required], #formCreateNasabah select[required], #formCreateNasabah textarea[required]'
                    );
                }
                ...
                const allFields = document.querySelectorAll(
                    '#formCreateNasabah input, #formCreateNasabah select, #formCreateNasabah textarea');
                ...
                const formCreate = document.getElementById('formCreateNasabah');
                if (formCreate) {
                    formCreate.addEventListener('submit', function(e) {
                        if (formCreate.dataset.confirmed === '1') return;
                        e.preventDefault();
                        ...
                        function doConfirm() {
                            ...
                            window.Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    formCreate.dataset.confirmed = '1';
                                    formCreate.submit();
                                }
                            });
                        }
